...
class Dokumenc extends CI_Controller {
    ...
    function proses_data_dokumen() {
    	...
    	if ($key != '') {
	        ...
	        $config['allowed_types'] = 'jpg|png|gif|pdf|docs|docx|doc|xlsx|xls';
	        ...
	        $config['allowed_types'] = 'jpg|png|gif|pdf|docs|docx|doc|xlsx';
...
/*===========================================================================================================================================*/
	...
	public function manage_data_kategori_dokumen()
	{
		...
		if ($id == '') {
	        ...
	        $data=array(
	            'headerTitle'=>'Data Kategori Dokumen',
	            'formTitle'=>'Form Tambah Kategori Dokumen',
	        ...
	        $data=array(
	            'headerTitle'=>'Data Kategori Dokumen',
	            'formTitle'=>'Form Ubah Kategori Dokumen',
