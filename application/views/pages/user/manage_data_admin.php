      ...
      <div class="row">
        ...
        <div class="col-md-12">
          ...
          <div class="box box-primary">
            ...
            <!-- /.box-header -->
            <!-- form start -->
            <form role="form" method="post" action="<?php echo base_url('userc/proses_data_admin')?>">
              <div class="box-body ">
                <?php if (isset($id)) { ?>
              ...
              <div class="box-footer">
                ...
                <a href="<?php echo base_url('userc/data_admin')?>" type="button" class="btn btn-warning">Kembali</a>
              </div>
            </form>
          </div>
          <!-- /.box -->
