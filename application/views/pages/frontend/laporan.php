        ...
        <div class="container">
          <div class="row slider-text align-items-center justify-content-center">
            <div class="col-md-8 text-center col-sm-12 element-animate pt-5">
              <h1 class="pt-5"><span>Laporan</span></h1>
            </div>
          </div>
        </div>
		...
		<div class="container">
			<div class="row">
				...
				<div class="col-lg-12">
		                ...
		                <thead>
		                  ...
		                  <tbody>                            
		                      ...
		                      <tr>
		                       ...
		                       <td><a href="#" data-toggle="modal" data-target="#myModal<?php echo $row->id_laporan; ?>">View</a></td>
		                      </tr>
		                      <?php }
		                        }
		                      ?>
					...
					?>
					<!-- Modal -->
					<div id="myModal<?php echo $row->id_laporan; ?>" class="modal fade" role="dialog">
					  <div class="modal-dialog">
					    ...
					    <div class="modal-content">
					      <div class="modal-header">
					        ...
					        <h4 class="modal-title">Download laporan <?php echo $row->nm_laporan; ?></h4>
					      </div>
					     <form target="_blank" method="post" action="<?php echo base_url('loginc/download_laporan/'.$row->file_laporan.'/'.$row->id_kategori_laporan) ?>">
