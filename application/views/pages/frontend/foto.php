<div class="top-shadow"></div>
  ...
  <section id="inner-headline">
    ...
    <div class="container">
      ...
      <div class="cbp-item <?php echo $row->id_foto ?>">
      
      <div class="cbp-caption">
      <div class="cbp-caption-defaultWrap">
      <img src="<?php echo base_url('uploads/berkas/'.$row->file_foto)?>" style="width: 248px; height: 300px;" /> 
      </div><!-- cbp-caption-defaultWrap -->
      <div class="cbp-caption-activeWrap">
      <div class="cbp-l-caption-alignCenter">
      <div class="cbp-l-caption-body">
      <center>
      <a href="<?php echo base_url('uploads/berkas/'.$row->file_foto)?>" class="cbp-lightbox cbp-l-caption-buttonRight">view larger</a> </center>
      </div><!-- cbp-l-caption-body -->
      </div><!-- cbp-l-caption-alignCenter -->
      <center>
      <div class="cbp-l-grid-projects-title"><?php echo $row->nm_foto ?></div></center>
      <center>
      <div class="cbp-l-grid-projects-title"><?php echo $row->tgl_foto ?></div></center>
